        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 mb-4">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="assets/Team/1.jpg" alt="wrapkit" class="img-fluid rounded-circle team-img" />
                        </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="assets/Team/2.jpg" alt="wrapkit" class="img-fluid rounded-circle team-img" />
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="pt-2">
                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe</h5>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="assets/Team/3.jpg" alt="wrapkit" class="img-fluid rounded-circle team-img" />
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="pt-2">
                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe</h5>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="assets/Team/4.jpg" alt="wrapkit" class="img-fluid rounded-circle team-img" />
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="pt-2">
                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe</h5>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="assets/Team/5.jpg" alt="wrapkit" class="img-fluid rounded-circle team-img" />
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="pt-2">
                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe</h5>
