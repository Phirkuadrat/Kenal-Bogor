...
if (!$tempat) {
    header('location: tempatWisataPage.php?failed=Data Tidak Ada');
    exit;
}
...
<body>
    ...
    <div class="container container-input py-5 mt-5 mb-5">
        ...
        <form action="action/updateWisata.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="assets/Tempat Wisata/<?php echo $tempat['gambar1']; ?>" alt="Gambar 1" class="mb-2" width="100">
            ...
            <div class="mb-3">
                ...
                <?php if ($tempat['gambar2']) { ?>
                    <img src="assets/Tempat Wisata/<?php echo $tempat['gambar2']; ?>" alt="Gambar 2" class="mb-2" width="100">
                <?php } ?>
            ...
            <div class="mb-3">
                ...
                <?php if ($tempat['gambar3']) { ?>
                    <img src="assets/Tempat Wisata/<?php echo $tempat['gambar3']; ?>" alt="Gambar 3" class="mb-2" width="100">
                <?php } ?>
            ...
            <a href="tempatWisataPage.php" class="btn btn-secondary">Kembali</a>
...
<script>
    document.getElementById('deleteButton').addEventListener('click', function() {
        if (confirm('Apakah Anda yakin ingin menghapus tempat ini?')) {
            window.location.href = 'action/deleteWisata.php?id=<?php echo $tempat['id']; ?>';
        }
    });
</script>