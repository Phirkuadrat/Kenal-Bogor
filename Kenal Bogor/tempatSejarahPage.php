...
<body>
    ...
    <div class="container mb-5">
        <div class="row mt-4">
            <?php foreach ($tempat_array as $row) { ?>
                <div class="col-md-4 mt-2">
                    <div class="content">
                        <a href="tempatSejarahDetailPage.php?id=<?php echo $row['id'] ?>">
                            <div class="content-overlay"></div>
                            <img class="content-image" src="assets/Tempat Bersejarah/<?php echo $row['gambar1'] ?>" alt="Gambar <?php echo $row['nama_tempat'] ?>">
